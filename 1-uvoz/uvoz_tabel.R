...
kalorije<-c(143,0,884, 295,0,88,255,306)
voda<-c(0,100,0, 7.6,0,76.45,10.51,7.16)
beljakovine<-c(12.58,0,0,38.3,0,0.49,10.95, 11)
mascobe<-c(9.94,0,0,4.6,0,0,3.26, 10.25)
